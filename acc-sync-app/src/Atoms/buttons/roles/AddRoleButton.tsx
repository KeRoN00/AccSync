...
import { AddRoleFormProps } from "../../../components/forms/add/AddRoleForm";
interface AddButtonProps {
  formComponent: React.ElementType<AddRoleFormProps>;
  onSubmit?: () => void;
  children: string;
}

const AddUserButton: React.FC<AddButtonProps> = ({
