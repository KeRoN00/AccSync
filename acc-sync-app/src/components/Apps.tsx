  ...
  return (
    <Layout user="admin">
      ...
      <div className="p-4 flex gap-3">
        ...
        <EditAppButton formComponent={EditAppForm} data={selectedApp}>
          Edytuj
        </EditAppButton>
        <DeleteAppButton formComponent={DeleteAppForm} data={selectedApp.id}>
          Usuń
        </DeleteAppButton>
      </div>
      <div className="flex items-center justify-center">
        {isLoading ? (
          ...
          <AppTable onAppSelect={handleSelectApp} data={responseData} />
        ) : (
          <div>Brak Danych</div>
        )}
      </div>
